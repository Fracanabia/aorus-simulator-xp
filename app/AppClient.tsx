  ...
  const chartData = useMemo(() => {
    ...
    for (let i = 1; i <= days; i++) {
      ...
      data.push({
        ...
        xp100: Math.floor(xp100Val * currentMobsPerMin * mins),
        xp120: Math.floor(xp120Val * currentMobsPerMin * mins),
        comp: Math.floor(compVal * currentMobsPerMin * mins),
        pk: Math.floor(pkVal * currentMobsPerMin * mins),
        relic: Math.floor(relicVal * currentMobsPerMin * mins),
        vip: Math.floor(vipVal * currentMobsPerMin * mins),
        phoenix: Math.floor(phoenixVal * currentMobsPerMin * mins),
